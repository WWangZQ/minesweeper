...
export type ServerMessage =
  | { type: 'room_created';  payload: { roomId: string; mode: GameMode; difficulty: Difficulty; players: Player[]; creatorId: string; myPlayerId: string } }
  | { type: 'room_joined';   payload: { roomId: string; players: Player[]; mode: GameMode; difficulty: Difficulty; creatorId: string; myPlayerId: string } }
